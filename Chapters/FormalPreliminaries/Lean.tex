...
\begin{itemize}
  \item \textbf{bvar} (bounded variable): variables bounded by a lambda or a quantifier, such as the second \texttt{n} in \tom{I don't know if I should use minted or texttt here} \mintinline{lean}{∀ (n : Natural), (n + zero) = n}. The \texttt{Nat} value they take as parameter is a natural number corresponding to their De Bruijn index~\cite{debruijnIndices}.
