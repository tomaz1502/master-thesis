...
% \node[main, label=right:$v_{2}$] (2) [right of=1] {$f$};
% \node[main, label=below:$v_{4}$] (4) [below of=1] {$b$};
% \node[main, label=below:$v_{5}$] (5) [below of=2] {$c$};
% \node[main, label=below:$v_{3}$] (3) [left of=4] {$a$};
% \draw[->] (1) -- (4);
% \draw[->] (2) -- (5);
\node[main, label=left:$v_{1}$] (1) {$f$};
...
% tem que falar que os vizinhos tao ordenados e que Child(v, i) eh o i-esimo vizinho de v
