...
Consider the following problem: given a set of variables and a set of functions, decide whether or not a given set of equalities between them is consistent or not.
