...
between \texttt{i} and \texttt{q}. More specifically, the following is the precise
statement of \texttt{tightLb} and \texttt{tightUb}, respectively:
...
Once again, this tactic could be just a theorem, except that cvc5 can apply it either
...
versions of these functions to proved the theorems, and, when the version of
the library was fixed, we substituted our version by it.
Our original proofs had over 150 lines each, which was a
