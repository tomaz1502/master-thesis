...
\subsection*{Pull\\\normalsize{Rule Statement:}}
\[
  \infer[]{A \vee P_{1} \vee \cdots \vee P_{i - 1} \vee P_{i + 1} \vee \cdots \vee P_{n}}{P_{1} \vee \cdots \vee P_{i - 1} \vee A \vee P_{i + 1} \vee P_{n} \mid A, s}
\]

Given a proof \texttt{pf} of the validity of a clause, a term $A$ and the index \texttt{s} of the last proposition, this tactic should produce a proof term for the same clause,
...
this tactic produces a proof of the same clause, with all duplicated terms of it removed. This
tactic will require two new theorems:
