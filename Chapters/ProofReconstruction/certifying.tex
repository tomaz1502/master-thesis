...
with the first instance of $A$ in the clause moved to the first position. This tactic was also created to facilitate the implementation
...
we can conclude that each one of them will be placed in the right position.
...
\texttt{A} is present in the first clause and \texttt{¬ A} is present in the second clause, this tactic produces a proof for the clause composed by the concatenation
