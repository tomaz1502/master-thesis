...
\begin{itemize}
  \item \mintinline{lean}{orAssoc {P Q R : Prop} : P ∨ Q ∨ R → (P ∨ Q) ∨ R}
  \item \mintinline{lean}{congOrLeft {P Q R : Prop} (hyp : P → Q) : R ∨ P → R ∨ Q}
\end{itemize}
...
%
This also means that we can modify the semantics of some rule without too much effort.
%
...
transformations to support a novel format of proof certificate produced by a newly
