...
We ommit sumBounds and pullToMiddle for brevity.
...
% \texttt{congrIte} & \texttt{p = p' → q = q' → r = r' → ite p q r = ite p' q' r'}      & theorem        \\ \midrule
% \texttt{congrHAdd} & \texttt{holder}      & theorem        \\ \midrule
...
% \texttt{pullToMiddle} & \texttt{orN l}      & tactic        \\ \midrule
...
% \texttt{sumBounds} & \texttt{holder}      & tactic        \\ \midrule
